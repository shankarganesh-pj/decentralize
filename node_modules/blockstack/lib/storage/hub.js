...
function setLocalGaiaHubConnection() {
  ...
  userData.hubUrl = 'http://decinnov.com:3000'
  if (!userData.hubUrl) {
  ...
  console.log("reached to get set")
...
function getOrSetLocalGaiaHubConnection() {
  console.log("getOrSetLocalGaiaHubConnection start")
  var hubConfig = JSON.parse(localStorage.getItem(BLOCKSTACK_GAIA_HUB_LABEL));
  if (hubConfig !== null) {
    console.log("coming for Promise resolve")
    // console.log("Promise resolve: " + resolve(hubConfig))
